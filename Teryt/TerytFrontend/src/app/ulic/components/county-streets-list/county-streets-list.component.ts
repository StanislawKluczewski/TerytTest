...
@Component({
  selector: 'app-county-streets-list',
  templateUrl: './county-streets-list.component.html',
  styleUrls: ['./county-streets-list.component.scss']
})
export class CountyStreetsListComponent implements OnInit {
  ...
  getCountyStreets(): void {
    this.ulicService.getStreetsInCounty(this.selected.value).subscribe(result => {
