...
@Component({
  selector: 'app-city-streets-list',
  templateUrl: './city-streets-list.component.html',
  styleUrls: ['./city-streets-list.component.scss']
})
export class CityStreetsListComponent implements OnInit {
  ...
  getStreetsInCities(): void {
    this.ulicService.getStreetsInCities(this.selected.value).subscribe(result => {
