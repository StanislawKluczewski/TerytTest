...
@Component({
  selector: 'app-cities-part-list',
  templateUrl: './cities-part-list.component.html',
  styleUrls: ['./cities-part-list.component.scss']
})
export class CitiesPartListComponent implements OnInit {
  ...
  getPartOfCities(): void {
    this.simcService.getPartOfCities(this.selected.value).subscribe(result => {
